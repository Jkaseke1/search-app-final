...
const FavouritesComponent = ({ favouritesProp, setFavouritesProp }) => {
    const unlikeFunc = (dataIndex) => {
        ...
        const newFavouritesArr = favouritesProp.filter((favourite, index) => index !== dataIndex);
                            ...
                            <div className="card mb-3" style={{ maxWidth: "540px" }}>
                                <div className="row g-0">
                                    <div className="col-md-4">
                                        <img src={dataPoint.artworkUrl100} alt="media art" className="img-fluid rounded-start" />
                                    </div>
