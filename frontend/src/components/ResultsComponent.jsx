                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <h5 className="card-title">
                                            <strong>{dataPoint.trackName}</strong> by {dataPoint.artistName}
                                        </h5>
                                        <p className="card-text">Cost: ${dataPoint.trackPrice} Dollars</p>
                                        <p className="card-text">Genre: {dataPoint.primaryGenreName}</p>
                                        <p className="card-text">
                                            <small className="text-muted">Kind: {dataPoint.kind}</small>
                                        </p>
                                        <p className="card-text">
                                            <small className="text-muted small-like-tag" onClick={() => likeUnlikeFuncProp(index)}>
                                                {dataPoint.likeStatus ? 'Unlike' : 'Like'}
                                                <button type="button" className="nav-link like-icons">
                                                    <FontAwesomeIcon
                                                        icon={dataPoint.likeStatus ? faHeart : faHeartRegular}
                                        ...
                                        <p className="card-text">
                                            Description: {dataPoint.description || dataPoint.shortDescription || "Not available."}
                                        </p>
                                        <br />
                                        <p className="card-text">
                                            Long Description: {dataPoint.longDescription || "Not available."}
                                        </p>
                                    </div>
                                </div>
                            </div>
